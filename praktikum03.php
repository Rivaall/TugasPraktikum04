                        ...
                        <form method="POST" action="praktikum03.php">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8">
                                    ...
                                    <div class="custom-control custom-checkbox custom-control-inline">
                                        <input name="skill[]" id="skill[]_2" type="checkbox" class="custom-control-input" value="PHP">
                                        <label for="skill[]_2" class="custom-control-label">PHP</label>
                                    </div>
                                    <div class="custom-control custom-checkbox custom-control-inline">
                                        <input name="skill[]" id="skill[]_3" type="checkbox" class="custom-control-input" value="Javascript">
                                        <label for="skill[]_3" class="custom-control-label">JavaScript</label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
